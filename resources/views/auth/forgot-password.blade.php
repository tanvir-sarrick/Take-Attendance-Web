                        ...
                        <div class="row m-t-20">
                            ...
                            <form class="col-12" action="{{ route('password.email') }}" method="POST">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input id="email" type="email" name="email" value="{{ old('email') }}" class="form-control form-control-lg" placeholder="Email Address" aria-label="Username" aria-describedby="basic-addon1" required>
                                </div>
                                <!-- pwd -->
                                <div class="row m-t-20 p-t-20 border-top border-secondary">
                                    <div class="col-12">
                                        <a class="btn btn-success" href="{{ route('login') }}" id="to-login" name="action">Back To Login</a>
                                        <button class="btn btn-info float-right" type="submit" name="action">Email Password Reset Link</button>
                                    </div>
                                </div>
                            </form>
                        </div>
